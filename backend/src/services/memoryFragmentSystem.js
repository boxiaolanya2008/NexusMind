...
const IMPORTANCE_DECAY_HOURS = 24;
...
class MemoryFragment {
  ...
  decayImportance() {
    ...
    const decayRate = hoursSinceAccess / IMPORTANCE_DECAY_HOURS;
...
export { MemoryFragment, MemoryFragmentSystem, MAX_FRAGMENTS_PER_USER, FRAGMENT_RETENTION_DAYS };
